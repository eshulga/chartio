<template>
  <div class="area">
    <div class="area__item" v-for="color in colors" :key="color.id" :style="'background-color: #' + color" @click="onClick(color)">
      <div class="area__item_shadow" v-if="activeItem[colors.indexOf(color)]"></div>
    </div>
  </div>
</template>
